...
@section('content-dinamis')
    <div class="container mt-5">
        <div class="d-flex justify-content-end">
            ...
            <a href="{{ route('data_obat.export-excel') }}" class="btn btn-success me-2">Export Data (excel)</a>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form class="modal-content" method="POST" action="">
                    ...
                    @csrf
                    {{-- menimpa method="post" jadi DELETE sesuai web.php httpmethod--}}
                    @method('DELETE')
        ...
        <div class="modal fade" id="modalEditStock" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <form class="modal-content" method="POST" action="">
                    @csrf
                    {{-- menimpa method="post" jadi patch sesuai web.php httpmethod--}}
                    @method('patch')
                    <div class="modal-header">
...
@push('script')
    ...
    <script>
        function showModalDelete(id, name) {
            // masukan teks dari parameter kedalam html bagian id="nama_akun"
            $('#nama_obat').text(name);
        ...
        // jika error isset (jika ada with failed, modal jangan di close)
